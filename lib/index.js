...
define(["require", "exports"], function (require, exports) {
    ...
    function validRule(rule, val, key) {
        return __awaiter(this, void 0, void 0, function () {
            var aRule, res, valType, k, i, ruleVal, status_1, _a, reg;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _b.label = 1;
                    case 1:
                        if (!(i < k.length)) return [3 /*break*/, 13];
                        ruleVal = rule[k[i]];
                        status_1 = true;
                        res.message = rule.message;
                        if (!rules.includes(k[i])) return [3 /*break*/, 11];
                        _a = k[i];
                        switch (_a) {
                            case 'required': return [3 /*break*/, 2];
                            case 'len': return [3 /*break*/, 3];
                            case 'min': return [3 /*break*/, 4];
                            case 'max': return [3 /*break*/, 5];
                            case 'enum': return [3 /*break*/, 6];
                            case 'type': return [3 /*break*/, 7];
                            case 'pattern': return [3 /*break*/, 8];
                            case 'validator': return [3 /*break*/, 9];
                        }
                        return [3 /*break*/, 11];
                    case 2:
                        {
                    ...
                    case 7:
                        {
                            status_1 = ruleVal.toLowerCase() === getType(val);
                            return [3 /*break*/, 11];
                        }
                        _b.label = 8;
                    case 8:
                        ...
                        _b.label = 9;
                    case 9:
                        if (!(getType(ruleVal) === 'function' && ruleVal)) return [3 /*break*/, 11];
